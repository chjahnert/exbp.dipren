...
@.\EXBP.Dipren.Demo.Postgres\bin\Debug\net6.0\EXBP.Dipren.Demo.Postgres.exe schedule "cuboid-001" --database %database% --batch-size 128 --batch-timeout 00:00:02 --reverse

@start .\EXBP.Dipren.Demo.Postgres\bin\Debug\net6.0\EXBP.Dipren.Demo.Postgres.exe monitor "cuboid-001" --database %database%
@timeout /t 1 /nobreak

@.\EXBP.Dipren.Demo.Postgres\bin\Debug\net6.0\EXBP.Dipren.Demo.Postgres.exe process "cuboid-001" --database %database% --threads 7 --clock-drift 00:00:00 --reverse

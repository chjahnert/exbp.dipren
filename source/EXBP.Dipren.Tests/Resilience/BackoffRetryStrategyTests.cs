...
namespace EXBP.Dipren.Tests.Resilience
{
    ...
    {
        private IBackoffDelayProvider DefaultDelayProvider { get; } = new PresetBackoffDelayProvider(TimeSpan.Zero);


        [Test]
        public void ExecuteAsync_ArgumentActionIsNull_ThrowsException()
        {
            BackoffRetryStrategy policy = new BackoffRetryStrategy(1, this.DefaultDelayProvider, PresetTransientErrorDetector.AlwaysTransient);
        ...
        {
            BackoffRetryStrategy policy = new BackoffRetryStrategy(1, this.DefaultDelayProvider, PresetTransientErrorDetector.NeverTransient);
        ...
        {
            BackoffRetryStrategy policy = new BackoffRetryStrategy(3, this.DefaultDelayProvider, PresetTransientErrorDetector.AlwaysTransient);

...
namespace EXBP.Dipren.Tests
{
    ...
    public class PartitionExtensionsTests
    {
        ...
        public void ToEntry_ValidPartiton_RetrunsEquivalentPartitionEntry()
        {
            ...
            Partition<int> source = new Partition<int>(partitionId, jobId, "machine-name/251/1/1442", created, updated, range, 621, 621, 403, true, 3.2, "machine-name/311/2/992");
            ...
            Assert.That(target.SplitRequester, Is.EqualTo(source.SplitRequester));
        }
    }
}

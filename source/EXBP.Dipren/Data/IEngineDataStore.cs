...
namespace EXBP.Dipren.Data
{
    ...
    public interface IEngineDataStore
    {
        ...
        ///   A job with the specified unique identifier does not exist in the data store.
        /// </exception>
        Task<Job> MarkJobAsReadyAsync(string jobId, DateTime timestamp, CancellationToken cancellation);
        ...
        ///   A job with the specified unique identifier does not exist in the data store.
        /// </exception>
        Task<Job> MarkJobCompletedAsync(string jobId, DateTime timestamp, CancellationToken cancellation);

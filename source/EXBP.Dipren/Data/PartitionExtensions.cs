...
namespace EXBP.Dipren.Data
{
    ...
    internal static class PartitionExtensions
    {
        ...
        internal static Partition<TKey> ToPartition<TKey>(this Partition source, IKeySerializer<TKey> serializer)
        {
            ...
            Partition<TKey> result = new Partition<TKey>(source.Id, source.JobId, source.Owner, source.Created, source.Updated, range, position, source.Processed, source.Remaining, source.IsCompleted, source.Throughput, source.SplitRequester);

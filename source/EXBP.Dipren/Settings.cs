...
namespace EXBP.Dipren
{
    ...
    /// </summary>
    [DebuggerDisplay("BatchSize = {BatchSize}, Timeout = {Timeout}")]
    public class Settings
    {
        ...
        /// </param>
        public Settings(int batchSize, TimeSpan timeout)
        {
        ...
        /// </param>
        public Settings(int batchSize, int timeout) : this(batchSize, TimeSpan.FromMilliseconds(timeout))
        {
        }
    }
}

...
namespace EXBP.Dipren
{
    ...
    internal static class PartitionExtensions
    {
        ...
        internal static Partition ToEntry<TKey>(this Partition<TKey> source, IKeySerializer<TKey> serializer)
        {
            ...
            Partition result = new Partition(source.Id, source.JobId, source.Created, source.Updated, first, last, source.Range.IsInclusive, position, source.Processed, source.Remaining, source.Owner, source.IsCompleted, source.Throughput, source.SplitRequester);

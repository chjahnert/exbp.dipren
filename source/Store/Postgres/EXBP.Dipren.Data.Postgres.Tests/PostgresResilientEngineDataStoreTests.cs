...
{
    [TestFixture]
    public class PostgresResilientEngineDataStoreTests : PostgresEngineDataStoreTests
    {
        ...
        protected override Task<IEngineDataStore> OnCreateEngineDataStoreAsync()
            => Task.FromResult<IEngineDataStore>(new PostgresResilientEngineDataStore(CONNECTION_STRING, DEFAULT_RETRY_LIMIT, this.DefaultRetryDely));
    }
}
